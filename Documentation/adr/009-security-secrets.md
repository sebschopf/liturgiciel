...
Le projet utilise des tokens Gitea, de potentielles clés de signature de code (pour Windows), et des variables de
configuration sensibles. Aucun de ces éléments ne doit se retrouver dans l'historique Git.
...
Une violation de cette règle est un motif de refus immédiat de PR, même si le secret a été retiré ultérieurement.
...
3. Réécrire l'historique Git si nécessaire.
